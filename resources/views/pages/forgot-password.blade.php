...
<head>
    ...
    <title>AgentHub - Forgot Password</title>
    <style>
...
<body>
    <main class="card">
        ...
        <p class="intro">Enter the email address for your AgentHub account and we will send you a password reset link.</p>
