<section class="page-section active" id="page-dashboard">
    ...
    <div class="two-col">
        <div class="card upload-card">
            ...
            <div class="upload-form-grid"><div><label class="form-label">Assign agent</label><select><option>Multi-platform agent</option><option>YouTube agent</option><option>Facebook agent</option><option>TikTok agent</option></select></div><div><label class="form-label">Publish to</label><div class="platform-checks"><span class="plat-check sel-yt"><svg width="14" height="14"><use href="#ico-youtube"/></svg> YouTube</span><span class="plat-check sel-fb"><svg width="14" height="14"><use href="#ico-facebook"/></svg> Facebook</span><span class="plat-check sel-tk"><svg width="14" height="14"><use href="#ico-tiktok"/></svg> TikTok</span></div></div></div>
