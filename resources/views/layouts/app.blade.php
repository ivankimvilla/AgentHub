    ...
    <main class="main">
        <header class="topbar">
            ...
            <div class="topbar-right"><div class="user-menu" id="user-menu">
                ...
                @endphp
                <div class="user-menu-panel"><button class="user-menu-item" data-page="account">My Account</button><button class="user-menu-item" data-page="settings">Settings</button><div class="user-menu-divider"></div><form method="POST" action="{{ route('logout') }}">@csrf<button class="user-menu-item danger" type="submit">Log out</button></form></div>
